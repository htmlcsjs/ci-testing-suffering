...
public final class MetaItems {
    ...
    static {
        ...
        orePrefixes.add(OrePrefix.toolHeadSword);
        orePrefixes.add(OrePrefix.toolHeadPickaxe);
        orePrefixes.add(OrePrefix.toolHeadShovel);
        orePrefixes.add(OrePrefix.toolHeadAxe);
        orePrefixes.add(OrePrefix.toolHeadHoe);
        orePrefixes.add(OrePrefix.toolHeadHammer);
        orePrefixes.add(OrePrefix.toolHeadFile);
        orePrefixes.add(OrePrefix.toolHeadSaw);
        ...
        orePrefixes.add(OrePrefix.toolHeadSense);
